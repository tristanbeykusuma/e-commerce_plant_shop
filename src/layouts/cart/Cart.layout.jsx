              ...
              {cartItems.length > 0 ? (
                cartItems.map((cartItem) => (
                  <tr key={cartItem.id}>
                    ...
                    <td>Rp. {cartItem.data.data.price}/=</td>
                    <td>
                      <div
                        className="btn-group"
                        role="group"
                    ...
                    <td>
                      Rp. {cartItem.data.data.price * cartItem.data.qty}/=
                    </td>
                  </tr>
                ))
              ) : (
        ...
        <div className="card m-3">
          <div className="card-body text-start m-2">
            ...
            <div className="row">
              ...
              <div className="col-6">
                <h6 className="card-subtitle mb-2 mt-2 text-end">
                  {cartItems.length > 0 ? "Rp. 400/= " : "Rp. 0/= "}
                </h6>
              </div>
              <hr />
              ...
              <div className="col-6">
                <h4 className="card-subtitle mb-2 mt-2 text-end">
                  {cartItems.length > 0
                    ? "Rp." + (calculateTotal(cartItems) + 400) + "/="
                    : "Rp. 0/= "}
                </h4>
              </div>
